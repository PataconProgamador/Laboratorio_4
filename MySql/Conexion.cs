...
namespace MySql
{
    ...
    {
        private static string cadenaConexion = "server=localhost;user=root;password=123456;database=lab_4";
        ...
        public static List<Producto> GetProducto(string filtro)
        {
